...
export const PersonProfileDossierScreen: React.FC<PersonProfileDossierScreenProps> = ({
  ...
  // Initial goals exactly as specified:
  // Build SaaS → 42 days
  // Run 10K → 67% complete
          ...
          <div className="space-y-2.5">
            {displayedGoals.map((goal) => (
              <div
                ...
                className="bg-white dark:bg-black border border-black/10 dark:border-white/10 rounded-2xl p-4 space-y-3 transition-all"
              >
                <div className="flex items-start justify-between gap-2">
                  <div className="flex items-center gap-2.5 min-w-0">
                    <div className="w-9 h-9 rounded-xl bg-black/[0.04] dark:bg-white/[0.06] flex items-center justify-center text-base shrink-0">
                      {goal.pillarIcon}
                    </div>
                    <div className="min-w-0">
                      <div className="flex items-center gap-1.5">
                  ...
                  {/* Goal Metric in Mono */}
                  <div className="font-mono text-xs font-semibold text-black dark:text-white bg-black/[0.03] dark:bg-white/[0.05] px-2.5 py-1 rounded-lg border border-black/5 dark:border-white/5 shrink-0">
                    {goal.metric}
                  </div>
                </div>
