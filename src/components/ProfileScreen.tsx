...
import { Flame, Grid, List, Edit3, Settings, Share2, Sparkles, CheckCircle2, RotateCcw, AlertTriangle, X, Bookmark, Image as ImageIcon, BarChart3, TrendingUp, Plus, Check, Trash2, Zap, Target, Calendar, Twitter } from 'lucide-react';
...
interface ProfileScreenProps {
  ...
  onPostHabit?: (payload: { content: string; imageUrl?: string; tags: string[] }) => void;
}
...
export const ProfileScreen: React.FC<ProfileScreenProps> = ({
  ...
  const [sharingHabit, setSharingHabit] = useState<PersonalHabit | null>(null);
  ...
  return (
    <div className="w-full pb-24 pt-2 px-3 sm:px-4 max-w-lg mx-auto space-y-4">
              ...
              {habits.map((habit) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Actions: Check-in toggle, Share as Photo/Tweet, & Delete */}
      ...
      {/* Habit Share as Photo / Tweet Modal */}
      {sharingHabit && (
        <HabitShareModal
          isOpen={!!sharingHabit}
          habit={sharingHabit}
