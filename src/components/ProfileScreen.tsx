...
import { Flame, Grid, List, Edit3, Settings, Share2, Sparkles, CheckCircle2, RotateCcw, AlertTriangle, Bookmark, BarChart3 } from 'lucide-react';
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-[11px] text-white/70 mt-0.5">
                  This will restore the sample users, streaks, posts, and direct messages to their initial states.
                </p>
      ...
      {activeDisplayPosts.length > 0 ? (
        ...
        <div className="text-center py-12 bg-white/5 rounded-[28px] border border-white/10 p-6">
          {profileTab === 'saved' ? (
            ...
            <>
              <Flame className="w-8 h-8 text-[#D4AF37]/50 mx-auto mb-2" />
              <h3 className="font-bold text-white text-sm">No proof updates posted yet</h3>
              <p className="text-xs text-white/40 mt-1">
                Tap the gold plus button below to share what you shipped or accomplished today!
              </p>
            </>
          )}
        </div>
