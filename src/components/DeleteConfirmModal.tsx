...
export const DeleteConfirmModal: React.FC<DeleteConfirmModalProps> = ({
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-[80] flex items-center justify-center p-4 bg-black/85 backdrop-blur-md animate-in fade-in duration-200"
      onClick={onClose}
    >
      <div
        ...
        {post && (
          <div className="p-3 bg-white/5 rounded-2xl border border-white/10 flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <span className="text-[10px] text-[#2F6FED] font-semibold mt-0.5 block">
