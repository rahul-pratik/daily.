        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              className="w-full px-3.5 py-2 bg-white/5 border border-white/10 rounded-xl text-xs text-white placeholder-white/30 focus:border-[#D4AF37] outline-none transition-colors resize-none"
            />
          </div>
                  ...
                  >
                    ...
                    <div
                      className={`w-4 h-4 rounded-full border flex items-center justify-center ${
                        isSelected ? 'bg-[#D4AF37] border-[#D4AF37] text-black font-bold' : 'border-white/30'
                      }`}
                    >
          ...
          <div className="pt-3 border-t border-white/5 flex items-center gap-2">
            ...
            <button
              type="submit"
              disabled={!name.trim()}
              className="flex-1 py-2.5 rounded-xl bg-[#D4AF37] hover:bg-[#D4AF37]/90 disabled:opacity-30 text-black font-black text-xs transition-all shadow-lg shadow-[#D4AF37]/20 flex items-center justify-center gap-1.5"
            >
