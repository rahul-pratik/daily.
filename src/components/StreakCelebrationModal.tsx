  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md animate-in fade-in duration-200">
      <div className="w-full max-w-sm bg-[#0A0A0A] border border-white/10 rounded-[32px] p-6 shadow-2xl text-center relative overflow-hidden">
        ...
        <div className="absolute -top-12 -left-12 w-36 h-36 bg-[#2F6FED]/10 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="relative inline-flex items-center justify-center my-4">
          <div className="w-20 h-20 rounded-full bg-white/5 border border-white/10 p-1 flex items-center justify-center shadow-xl">
            <Flame className="w-10 h-10 text-[#2F6FED] fill-[#2F6FED] animate-pulse" />
          </div>
          <span className="absolute -top-1 -right-1 flex h-5 w-5">
            <span className="relative inline-flex rounded-full h-5 w-5 bg-[#2F6FED] items-center justify-center text-black font-black text-[10px]">
              ★
            </span>
          </span>
        </div>
        ...
        <div className="my-5 p-3.5 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-around">
          ...
          <div className="text-center">
            ...
            <span className="text-xs font-bold text-[#2F6FED] flex items-center justify-center gap-1 mt-0.5">
              <Flame className="w-3.5 h-3.5 fill-[#2F6FED]" /> {streakCount} Days
            </span>
          </div>
        </div>
        ...
        <button
          onClick={onClose}
          className="w-full py-3.5 rounded-2xl bg-[#2F6FED] text-white font-black text-xs uppercase tracking-wider flex items-center justify-center gap-2 hover:bg-[#2F6FED]/90 active:scale-[0.98] transition-all shadow-lg shadow-[#2F6FED]/20"
        >
